...
export const components: Record<string, Component> = {
  'KOL-ABBR': () => (
    ...
    <div class="grid gap-2"> 
      <p>Ich bin eine <KolAbbr 
        _title="Ausführliche Beschreibung"
        _align="top"
        >ABB</KolAbbr> mit Tooltip oben
      </p>
      <p>Ich bin eine <KolAbbr 
        _title="Ausführliche Beschreibung"
        _align="right"
        >ABB</KolAbbr> mit Tooltip rechts
      </p>
      <p>Ich bin eine <KolAbbr 
        _title="Ausführliche Beschreibung"
        _align="bottom"
        >ABB</KolAbbr> mit Tooltip unten
      </p>
      <p>Ich bin eine <KolAbbr 
        _title="Ausführliche Beschreibung"
        _align="left"
        >ABB</KolAbbr> mit Tooltip links
      </p>
      </div>
    </>
  ),
  'KOL-ACCORDION': () => (
    ...
    <div class="grid grid-cols-1 gap-2"> 
      <KolAccordion
        _level={1}
        _heading='Überschrift Accordion 1'
      >
        <div slot="content">
      ...
      <KolAccordion
        _level={1}
        _heading='Überschrift Accordion 2'
      >
        <div slot="content">
      ...
      <KolAccordion
        _level={1}
        _heading='Überschrift Accordion 3'
      >
        <div slot="content">
  ...
  'KOL-ALERT': () => (
    ...
    <div class="grid grid-cols-1 gap-2"> 
      ...
      <KolAlert
        _level={1}
        _heading='Fehlermeldung'
        _type="error"
      >
      </KolAlert>
      <KolAlert
        _level={1}
        _heading='Warnmeldung'
        _type="warning"
      >
      </KolAlert>
      </div>
  ...
  'KOL-CARD': () => (
    <div class="grid grid-cols-1 gap-2">
      <KolCard 
        _hasFooter
        _headline="Überschrift der Card"
        _level={1}
      >
        <div slot="content">
          Inhalt der Card
